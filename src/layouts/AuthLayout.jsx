      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-24 h-full min-h-screen">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
             <div className="w-12 h-12 rounded-xl gradient-teal-glow flex items-center justify-center shadow-2xl shadow-teal-accent/30 border border-white/10">
                <span className="font-bold text-2xl text-white">A</span>
             </div>
             <h1 className="text-4xl font-bold tracking-tight text-white">ADVYON</h1>
          </div>
          
          <h2 className="text-5xl font-bold leading-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white via-muted-foreground to-white/50">
          ...
          <div className="flex items-center gap-4 text-sm font-medium text-teal-accent">
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-primary/50 border border-teal-accent/30 backdrop-blur-md">
        ...
        >
          <div className="relative group">
            ...
            <div className="absolute -inset-0.5 gradient-teal-glow rounded-2xl blur opacity-30 group-hover:opacity-75 transition duration-1000"></div>
            <Outlet />
          </div>
