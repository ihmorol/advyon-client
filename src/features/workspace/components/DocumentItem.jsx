...
const DocumentItem = ({ name, type, date, status, indent = 0 }) => (
    <div
        className="group flex items-center justify-between py-2 px-3 hover:bg-[#153433] rounded-md cursor-pointer transition-colors border-b border-[#3A7573]/20 last:border-0 animate-in fade-in slide-in-from-bottom-1 duration-300"
    ...
    >
        ...
        <div className="flex items-center gap-3">
            ...
            <MoreVertical size={14} className="text-[#B0C4C3] opacity-0 group-hover:opacity-100 hover:text-white transition-opacity" />
        </div>
    </div>
);
